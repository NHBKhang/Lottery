...
namespace Lottery
{
    public partial class Form2 : Form
    {
        ...
        private void btChot_Click(object sender, EventArgs e)
        {
            ...
            XoSo ve3So = new VeBaSo();
            lb11.Text = ve3So.Num(0).ToString();
            lb12.Text = ve3So.Num(1).ToString();
            lb13.Text = ve3So.Num(2).ToString();

            XoSo ve4So = new VeBonSo();
            lb21.Text = ve4So.Num(0).ToString();
            lb22.Text = ve4So.Num(1).ToString();
            lb23.Text = ve4So.Num(2).ToString();
            lb24.Text = ve4So.Num(3).ToString();

            XoSo ve5So = new VeNamSo();
            lb31.Text = ve5So.Num(0).ToString();
            lb32.Text = ve5So.Num(1).ToString();
            lb33.Text = ve5So.Num(2).ToString();
            lb34.Text = ve5So.Num(3).ToString();
            lb35.Text = ve5So.Num(4).ToString();

            XoSo ve6So = new VeSauSo();
            lb41.Text = ve6So.Num(0).ToString();
            lb42.Text = ve6So.Num(1).ToString();
            lb43.Text = ve6So.Num(2).ToString();
            lb44.Text = ve6So.Num(3).ToString();
            lb45.Text = ve6So.Num(4).ToString();
            lb46.Text = ve6So.Num(5).ToString();
        ...
        {
            XoSo player = new PlayerNum();
            textBox1.Text = player.Num(0).ToString();
            textBox2.Text = player.Num(1).ToString();
            textBox3.Text = player.Num(2).ToString();
            textBox4.Text = player.Num(3).ToString();
            textBox5.Text = player.Num(4).ToString();
            textBox6.Text = player.Num(5).ToString();
        }
